package com.bankicp.library.ImageView;
...
public class RoundedImageView extends ImageView {
    ...
    private static final ScaleType[] SCALE_TYPES = {ScaleType.MATRIX, ScaleType.FIT_XY, ScaleType.FIT_START, ScaleType.FIT_CENTER,
