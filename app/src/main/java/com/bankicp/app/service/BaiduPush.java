...
public class BaiduPush {
    ...
    public String PostHttpRequest(RestApi data) {
        ...
        // data.put(RestApi._TIMESTAMP,Long.toString(System.currentTimeMillis()
        // / 1000));
        ...
        // System.out.println("_SIGN ==>"+sb.toString());
        // data.put(RestApi._SIGN, Util.MD5(urlencode(sb.toString())));
        //
        // } catch (Exception e)
        // {
        // e.printStackTrace();
        ...
        // try {
        // response = com.nscg.app.utils.HttpRequest.sendPostRequest(mUrl +
        // channel, data, "UTF-8");
        // } catch (Exception e) {
        ...
        try {
            ...
            // md.reset();
            // // md.update( URLEncoder.encode(sb.toString(),
            // "utf-8").getBytes()
            // // );
            //
     ...
     * @return
     */
    // 08-23 17:50:51.381: E/TAG(2262): User [UserId=701905344493308477,
    // channelId=4501413983738169951, nick=思密达, headIcon=2130837560, group=0]
