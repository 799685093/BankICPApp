...
public final class CrashReportConfig {
	...
	public final static int RES_TOAST_TEXT = R.string.crash_toast_text;
	/** 邮件标题的字符串id */
	public final static int RES_EMAIL_SUBJECT = R.string.crash_subject;

	/** 收件邮箱 */
	public final static String EMAIL_RECEIVER = "test@qq.com";


	/** 程序名 */
	public final static String APP_NAME = "com.gdpi";

	
	
	/** 崩溃日志保存路径 */
	public final static String LOG_PATH = Environment.getExternalStorageDirectory().getPath() + "/" + "0CRASH"  +"/Log/";
	...
	/** 额外的程序包标签 */
	public final static String ADDITIONAL_TAG = "CustomInfo";
